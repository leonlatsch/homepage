<template>
    <div>
        ...
        <p>
            At leonlatsch.dev, accessible from https://leonlatsch.dev, one of our main
            priorities is the privacy of our visitors. This Privacy Policy document
            contains types of information that is collected and recorded by
            leonlatsch.dev and how we use it.
        </p>
        ...
        <p>
            ...
            and/or collect in leonlatsch.dev. This policy is not applicable to any
            ...
            and the
            <a href="https://www.privacypolicies.com/privacy-policy-generator/">Free Privacy Policy Generator</a>.
        </p>
        ...
        <p>
            leonlatsch.dev follows a standard procedure of using log files. These
        ...
        <P>You may consult this list to find the Privacy Policy for each of the
            advertising partners of leonlatsch.dev.</P>

        <p>
            Third-party ad servers or ad networks uses technologies like cookies,
            JavaScript, or Web Beacons that are used in their respective
            advertisements and links that appear on leonlatsch.dev, which are sent
        ...
        <p>
            Note that leonlatsch.dev has no access to or control over these cookies
        ...
        <p>
            leonlatsch.dev's Privacy Policy does not apply to other advertisers or
        ...
        <p>
            leonlatsch.dev does not knowingly collect any Personal Identifiable
